...
public class Binary implements Comparable{
	...
	/****** YOUR IMPLEMENTATION HURRR ******/
	int binarylength = s.length()-1;
    int retInt = 0;
	for (int i=0; i<= bin_length; i++){
	    retInt +=(Integer.parseInt(s.substring(i,i+1))* Math.pow(2,(binarylength-i)));}
	return retInt;
    }
	...
	boolean isEquals = this == other;
	if (!isEquals){
	    isEquals = (other instanceof Binarry && ((this).compareTo((Binary)other))==0);
	}
	return isEquals;
    }
	/****** YOUR IMPLEMENTATION HURRR ******/   
	...
	/****** YOUR IMPLEMENTATION HURRR ******/
	Binary i = (Binary)other;
	if(this._decNum ==  i._decNum){
	    return 0;
	}
	else if (this._decNum < i._decNum){
	    return 9001;
	}
	else {
	    return -9001;
